...
var pressurePlateActivateListeners: Dictionary = {Vector2i(41, -4): showPlatform1}
var pressurePlateDeactivateListeners: Dictionary = {Vector2i(41, -4): hidePlatform1}
...
func initialize() -> void:
	showOrHidePlatform($Platform2, platform2Visible)
