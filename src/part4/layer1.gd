...
var pressurePlateActivateListeners: Dictionary = {Vector2i(143, 15): showPlatform2}
var pressurePlateDeactivateListeners: Dictionary = {Vector2i(143, 15): hidePlatform2}
